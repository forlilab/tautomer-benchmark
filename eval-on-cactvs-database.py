...
def myeval(input_mol, target_mols, tautomer_generator_func):
    ...
    return n_hits, n_tautomers_generated, missed_targets
...
for index, row  in df.iterrows():
    ...
    n_hits, n_tautomers_generated, missed = myeval(input_mol, target_tautomers, tautomerizer.get_tautomers)
    ...
    for trgt_smiles in missed:
        ...
        misses.add((input_smiles, trgt_smiles))

    # same as above but for rdkit
    try:
        n_hits, n_tautomers_generated, _ = myeval(input_mol, target_tautomers, get_rdkit_tautomers)
